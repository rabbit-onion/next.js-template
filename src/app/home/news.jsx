...
const News = () => {
  return (
    <Section title='뉴스'>
      {/* tailwind ver */}
      <ul className='grid  grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4'>
        {mockNews.map((news, index) => (
          <li key={index}>
            <AspectRatio ratio={2 / 1}>
              <Image src={news.imageUrl} alt={news.title} width={800} height={500} className='w-full h-50 rounded-lg mb-4' />
            </AspectRatio>
